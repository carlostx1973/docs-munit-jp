...
// *デフォルト値: `${project.build.directory}/surefire-reports/`*
...
// *デフォルト値: `${project.build.directory}/munit-reports/coverage-report.data`*

// | coverageConfigDataFile
// | File
// | Directory where the coverage report configuration file lives. +
// *デフォルト値: ${project.build.directory}/munit-reports/coverage-config.data"*

// |muleWorkingDirectory
// |File
// |Directory to be used as Mule working directory. +
// *デフォルト値: `${project.build.directory}/.mule`*
